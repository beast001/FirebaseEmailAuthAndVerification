...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main); mEmail = (EditText) findViewById(R.id.email);
                ...
                if(!isEmpty(mEmail.getText().toString())
                    ...
                    Log.d(TAG, "onClick: attempting to authenticate.");
                      ...
                      FirebaseAuth.getInstance().signInWithEmailAndPassword(mEmail.getText().toString(),
                          ...
                          Toast.makeText(LoginActivity.this,"Authentification Filed", Toast.LENGTH_LONG).show();
                          hideDialog();
                          }
                      });
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user!=null){
                    ...
                    if (user.isEmailVerified()) {
                        ...
                        Toast.makeText(LoginActivity.this, " Check Your Inbox for a Verification Email",Toast.LENGTH_LONG).show();
